...
public class Timetrackingsituation {
   ...
   * @return isforabsent
  **/
  @ApiModelProperty(value = "Indica se o afastamento considera absenteísmo")
  ...
  **/
   ...
   * @return name
  **/
  @ApiModelProperty(value = "Nome do afastamento")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(isforabsent, stabilityType, code, loseVacationRight, loseVacation, situationDaysJustified, stabilityDay, generateStability, maximumStabilityDays, trackingtype, name, returnExamination, id, extensionControl);
  }
