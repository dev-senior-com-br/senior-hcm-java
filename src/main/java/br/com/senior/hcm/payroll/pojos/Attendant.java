...
public class Attendant {
  ...
  **/
  @ApiModelProperty(required = true, value = "Situação do registro")
   ...
   * @return code
  **/
  @ApiModelProperty(required = true, value = "Código do atendente")
  ...
  **/
  @ApiModelProperty(required = true, value = "Registro profissional")
   ...
   * @return name
  **/
  @ApiModelProperty(required = true, value = "Nome do atendente")
