...
public class Wagescalerevision {
   ...
   * @return enddate
  **/
  @ApiModelProperty(required = true, value = "Data do fim da revisão de escala salarial")
  ...
  **/
   ...
   * @return startdate
  **/
  @ApiModelProperty(required = true, value = "Data de inicio da revisão de escala salarial")
