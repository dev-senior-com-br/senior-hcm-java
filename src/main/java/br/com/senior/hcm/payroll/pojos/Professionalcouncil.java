...
public class Professionalcouncil {
   ...
   * @return code
  **/
  @ApiModelProperty(value = "Código conselho profissional")
  ...
  **/
   ...
   * @return name
  **/
  @ApiModelProperty(value = "Descrição conselho profissional")
  ...
  **/
   ...
   * @return region
  **/
  @ApiModelProperty(value = "Região conselho profissional")
