...
public class Actingtype {
   ...
   * @return code
  **/
  @ApiModelProperty(value = "Código do tipo de atuação")
   ...
   * @return goal
  **/
  @ApiModelProperty(value = "Objetivo")
  ...
  **/
  @ApiModelProperty(value = "Porcentagem do pagamento do posto adicional")
   ...
   * @return name
  **/
  @ApiModelProperty(value = "Descrição do tipo de atuação")
  ...
  **/
  @ApiModelProperty(value = "Consistir característica?")
  ...
  **/
   ...
   * @return mainhistory
  **/
  @ApiModelProperty(value = "Histórico principal?")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(code, goal, additionalPaymentType, additionalPaymentPercentage, name, consistCharacteristic, jobActingType, id, mainhistory);
  }
