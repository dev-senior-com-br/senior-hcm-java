...
import io.swagger.client.model.RecruitmentProcessStageIntegrationResponsiblePerson;
import io.swagger.client.model.RecruitmentProcessStageIntegrationStatus;
import io.swagger.client.model.RecruitmentProcessStageProcess;
import io.swagger.client.model.RecruitmentProcessStageSeemMedicalStatus;
import io.swagger.client.model.RecruitmentProcessStageStage;
import io.swagger.client.model.RecruitmentProcessStageStatus;
...
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2020-08-11T22:12:59.415Z")



public class RecruitmentProcessStage {
  @SerializedName("process")
  private RecruitmentProcessStageProcess process = null;
  ...
  private RecruitmentProcessStageSeemMedicalStatus seemMedicalStatus = null;

  @SerializedName("integrationStatus")
  private RecruitmentProcessStageIntegrationStatus integrationStatus = null;
  ...
  private RecruitmentProcessStageIntegrationResponsiblePerson integrationResponsiblePerson = null;

  @SerializedName("status")
  private RecruitmentProcessStageStatus status = null;

  @SerializedName("stageId")
  private String stageId = null;

  public RecruitmentProcessStage process(RecruitmentProcessStageProcess process) {
  ...
  **/
  ...
  public RecruitmentProcessStageProcess getProcess() {
    return process;
  }

  public void setProcess(RecruitmentProcessStageProcess process) {
    this.process = process;
  }

  public RecruitmentProcessStage stage(RecruitmentProcessStageStage stage) {
    this.stage = stage;
    return this;
  }
  ...
  **/
  ...
  public RecruitmentProcessStage seemMedicalStatus(RecruitmentProcessStageSeemMedicalStatus seemMedicalStatus) {
  ...
  **/
  @ApiModelProperty(value = "")
  public RecruitmentProcessStageSeemMedicalStatus getSeemMedicalStatus() {
    return seemMedicalStatus;
  }

  public void setSeemMedicalStatus(RecruitmentProcessStageSeemMedicalStatus seemMedicalStatus) {
    this.seemMedicalStatus = seemMedicalStatus;
  }

  public RecruitmentProcessStage integrationStatus(RecruitmentProcessStageIntegrationStatus integrationStatus) {
  ...
  **/
  @ApiModelProperty(value = "")
  public RecruitmentProcessStageIntegrationStatus getIntegrationStatus() {
    return integrationStatus;
  }

  public void setIntegrationStatus(RecruitmentProcessStageIntegrationStatus integrationStatus) {
    this.integrationStatus = integrationStatus;
  }
  ...
  **/
  ...
  public RecruitmentProcessStage integrationResponsiblePerson(RecruitmentProcessStageIntegrationResponsiblePerson integrationResponsiblePerson) {
  ...
  **/
  @ApiModelProperty(value = "")
  public RecruitmentProcessStageIntegrationResponsiblePerson getIntegrationResponsiblePerson() {
    return integrationResponsiblePerson;
  }

  public void setIntegrationResponsiblePerson(RecruitmentProcessStageIntegrationResponsiblePerson integrationResponsiblePerson) {
    this.integrationResponsiblePerson = integrationResponsiblePerson;
  }

  public RecruitmentProcessStage status(RecruitmentProcessStageStatus status) {
    this.status = status;
    return this;
  }
  ...
  **/
  @ApiModelProperty(value = "")
  public RecruitmentProcessStageStatus getStatus() {
    return status;
  }

  public void setStatus(RecruitmentProcessStageStatus status) {
    this.status = status;
  }
