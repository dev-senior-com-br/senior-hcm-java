...
public class FamilySalary {
  ...
  **/
  @ApiModelProperty(required = true, value = "Idade limite do salário familia")
  ...
  **/
  @ApiModelProperty(required = true, value = "Aviso impresso")
  ...
  **/
  @ApiModelProperty(required = true, value = "Data de entrega da certidão")
