...
public class FinancialIndex {
  ...
  **/
   ...
   * @return code
  **/
  @ApiModelProperty(required = true, value = "Código do índice")
  ...
  **/
  @ApiModelProperty(required = true, value = "Quantidade de decimais")
   ...
   * @return name
  **/
  @ApiModelProperty(required = true, value = "Nome do índice")
  ...
  **/
  @ApiModelProperty(required = true, value = "Quantidade de dígitos")
